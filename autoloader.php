 ...
 */
function __dm_autoload_463( $name )
{
	$map = array (
  ...
  'Yandex\\Fotki\\Exception\\Api\\ServerError' => 'source/Yandex/Fotki/Exception/Api/ServerError.php',
...
spl_autoload_register( '__dm_autoload_463' );
